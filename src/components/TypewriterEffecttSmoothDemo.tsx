...
export function TypewriterEffectSmoothDemo() {
  const words = [
    ...
    },
    {
      ...
      className: "text-verdePrimario dark:text-verdePrimario",
    },
  ];
  return (
    <div className="flex flex-col items-center justify-center h-[30rem]  ">
      ...
      <div className="mt-16 flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4">
        <button className="w-40 h-10 rounded-xl bg-verdePrimario border dark:border-white border-transparent text-white text-sm">
          Join now
        </button>
